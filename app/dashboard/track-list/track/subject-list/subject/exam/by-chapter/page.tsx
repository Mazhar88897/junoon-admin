    ...
    <div className="max-w-4xl mx-auto p-6">
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-gray-50 p-4 rounded-lg space-y-2">
          ...
          <h2 className="text-2xl font-bold mb-4">Exam Information By Chapters </h2>
          
          <div className="flex gap-3">
            <label className="block text-sm font-bold ">Subject</label>
            <p className="text-sm font-bold">{sessionData.subjectName}</p>
            <p className="text-sm font-bold px-2 bg-gray-800 rounded-xs text-white  ">ID : {sessionData.subjectId}</p>
          </div>

          <div className="flex gap-3">
            <label className="block text-sm font-bold ">Subject Description</label>
            <p className="text-sm font-bold ">{sessionData.subjectDescription}</p>
          </div>

          <div className="flex gap-3">
            <label className="block text-sm font-bold ">Track ID: </label>
            <p className="text-sm font-bold ">{sessionData.trackId}</p>
          </div>

                <div className="flex gap-3">
            <label className="block text-sm font-bold   ">Exam Type: </label>
            <p className="text-sm font-bold text-gray-900">By Chapter Exam</p>
          </div>
        </div>
