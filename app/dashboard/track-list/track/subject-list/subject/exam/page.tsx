...
const categories = [
  {
    key: "/dashboard/track-list/track/subject-list/subject/exam/by-chapter",
    name: "Exam by Chapter",
    subCount: 4,
  ...
  {
    key: "/dashboard/track-list/track/subject-list/subject/exam/grand-test",
    name: " Grand Test",
    subCount: 5,
...
export default function TrackCategoryPage() {
  return (
    <div className="p-6 bg-slate-50 min-h-screen">
      <h1 className="text-xl font-bold mb-1">Exam Category</h1>
      ...
      <h1 className="text-xl font-bold mb-1">Practice Exams</h1>
      <p className="text-gray-500 mb-6 text-sm">You have total {categories.length} Categories</p>
      <div className="flex flex-wrap gap-4">
        {categories.map((cat) => (
          <Link
