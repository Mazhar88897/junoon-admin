"use client";
import { StickyNote, TableIcon } from "lucide-react";
import Link from "next/link";
// chapter /  recorded lecture  / add note
TableIcon
const categories = [
    {
        key: "/dashboard/track-list/track/subject-list/subject-cards/chapters/content/content-cards/notes",
        name: " Notes Management",
        subCount: 5,
        description: "Upload and organize notes.",
        color: "bg-yellow-400",
        icon: <TableIcon />,
        code: "WD",
        tags: [
  ...
  {
    key: "/dashboard/track-list/track/subject-list/subject-cards/chapters/content/content-cards/videos",
    name: "Video Management",
    subCount: 4,
    description: "Upload and organize video lectures.",
    color: "bg-violet-500",
    icon: <StickyNote />,
    code: "GD",
    tags: [
