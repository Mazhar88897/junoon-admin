...
const categories = [
  ...
  {
    key: "/dashboard/track-list/track/subject-list/subject-cards/chapters/content/exam/all-tests",
    name: " Chapter's Exam",
    subCount: 5,
    description: "Create a Chapter Exam for each Chapter in a Subject",
    color: "bg-yellow-400",
    code: "WD",
    icon: <BookOpenCheck />,
...
export default function TrackCategoryPage() {
  ...
  return (
    <div className="p-6 bg-slate-50 min-h-screen">
      <h1 className="text-xl font-bold mb-6">Chapter Exam</h1>
      ...
      <div className="flex flex-wrap gap-4">
        {categories.map((cat) => (
            ...
            //  href={`${cat.key}`}
            onClick={() => {
              sessionStorage.setItem("is_practice_exam_chapter_test", "false");
              console.log("Setting is_practice_exam_chapter_test to false");
              console.log("Value after setting:", sessionStorage.getItem("is_practice_exam_chapter_test"));
              router.push(cat.key);
            }}
      ...
      <h1 className="text-xl font-bold mb-6  mb-1">Practice Chapter Exam</h1>
      {/* <p className="text-gray-500 mb-6 text-sm">You have total {categories.length} Categories</p> */}
      <div className="flex flex-wrap gap-4">
        {categories.map((cat) => (
         <div
         ...
         //  href={`${cat.key}`}
         onClick={() => {
          sessionStorage.setItem("is_practice_exam_chapter_test", "true");
          console.log("Setting is_practice_exam_chapter_test to true");
          console.log("Value after setting:", sessionStorage.getItem("is_practice_exam_chapter_test"));
          router.push(cat.key);
        }}
         className="block w-[500px] group cursor-pointer"
