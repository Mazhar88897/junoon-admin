...
const categories = [
    {
        key: "/dashboard/track-list/track/subject-list/subject-cards/chapters/content/content-cards",
        name: " Content Management",
        subCount: 5,
        description: "Upload and organize study materials, including notes and video lectures.",
        color: "bg-yellow-400",
        icon: <TableIcon />,
        code: "WD",
        tags: [
